...
func InitOptionMap() {
	...
	common.OptionMap["RecordErrorIpLog"] = strconv.FormatBool(common.RecordErrorIpLog)
	...
	common.OptionMap["ResolutionRatio"] = ratio_setting.ResolutionRatio2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "RecordErrorIpLog" {
		...
		case "RecordErrorIpLog":
			common.RecordErrorIpLog = boolValue
	...
	case "SubscriptionCommissionRate":
		common.SubscriptionCommissionRate, _ = strconv.ParseFloat(value, 64)
	...
	case "ResolutionRatio":
		err = ratio_setting.UpdateResolutionRatioByJSONString(value)
	case "TopUpLink":
