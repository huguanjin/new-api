...
// GetApiInfoForToken 返回 show_in_token 为 true 的 API 信息条目
func GetApiInfoForToken() []map[string]interface{} {
	all := GetApiInfo()
	var result []map[string]interface{}
	for _, item := range all {
		if showInToken, ok := item["show_in_token"]; ok && showInToken == true {
