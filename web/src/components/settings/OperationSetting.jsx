...
import SettingsAdminPermissions from '../../pages/Setting/Operation/SettingsAdminPermissions';
  ...
  return (
    <>
      <Spin spinning={loading} size='large'>
        ...
        {/* 计费设置 */}
        <Card style={{ marginTop: '10px' }}>
          <SettingsBilling options={inputs} refresh={onRefresh} />
        </Card>
      </Spin>
    </>
  );
