...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"AdminRolePermissions":  common.OptionMap["AdminRolePermissions"],
	...
	// 令牌页单独过滤 show_in_token 的条目
	apiInfoToken := console_setting.GetApiInfoForToken()
	if len(apiInfoToken) > 0 {
		data["api_info_token"] = apiInfoToken
	}
